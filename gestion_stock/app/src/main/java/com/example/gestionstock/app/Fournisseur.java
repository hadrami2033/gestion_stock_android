...
public class Fournisseur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameInput = findViewById(R.id.nameFrInput);
        teleInput = findViewById(R.id.teleFrInput);
        imageView = findViewById(R.id.imageFournisseur);

        getSupportActionBar().setTitle("Ajout de Fournisseur"); // set the top title
    ...
    public void onSaveTapped(View view) {
        if(nameInput.length() > 0 && teleInput.length() > 0) {
            ...
            Toast.makeText(this, "Fournisseur a ajouté avec succée!", Toast.LENGTH_SHORT).show();
            gotToHome();
        }else{
